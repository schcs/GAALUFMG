---
title: "Vetores"
author: "Francisco Dutenhefner/Csaba Schneider"
date: "agosto de 2025"
format:
  revealjs:
    slide-level: 3
...
![](img/05_vetores/fig12.png){.nostretch width=40% fig-align="center"}

$$
\overrightarrow{OP} + \overrightarrow{PQ} = \overrightarrow{OQ}
\;\Rightarrow\; P + \overrightarrow{PQ} = Q
...
Se $P=(2,4)$ e $Q=(5,2)$, então $\overrightarrow{PQ} = Q - P = (5,2) - (2,4) = (3,-2)$. 

![](img/05_vetores/fig13.png){.nostretch width=50% fig-align="center"}
...
![](img/05_vetores/fig08_1.png){width=60%}
...
![](img/05_vetores/fig10_1.png){.nostretch width=50% fig-align="center"}
...
3. $\theta=90^\circ$ se $\langle V,W\rangle = 0$. 
...
$$
W = R_{90^\circ}V = \begin{bmatrix} \cos 90^\circ & -\sin 90^\circ \\ \sin 90^\circ & \cos 90^\circ \end{bmatrix}\!\begin{bmatrix} a \\ b \end{bmatrix}
= \begin{bmatrix} 0 & -1 \\ 1 & 0 \end{bmatrix}\!\begin{bmatrix} a \\ b \end{bmatrix}
= \begin{bmatrix} -b \\ a \end{bmatrix}.
$$ 

Observe que $\lVert V\rVert = \lVert W\rVert$ e $\langle V,W\rangle = -ab + ab = 0$. 
