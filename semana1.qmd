...
-   A matriz $D$ é $1 \times 3$ (1 linha e 3 colunas, [matriz linha]{.bg-yellow}, [vetor linha]{.bg-yellow}).
-   A matriz $E$ é $3 \times 1$ (3 linhas e 1 coluna, [matriz coluna]{.bg-yellow}, [vetor coluna]{.bg-yellow}).
...
A [simétrica/negativa]{.text-red} de uma matriz $A$ é definida por [ $-A = (-1)A$ ]{.bg-yellow}. Em particular, se $A = (a_{ij})$, então 
$$
-A = (-a_{ij}).
$$
